<%@include file="header.jsp"%>
 <link rel="stylesheet" href="/css/course.css?after" type="text/css">
	...
	<div class="intro">
		<div class="intro_background parallax-window" data-parallax="scroll" data-image-src="/img/intro.jpg" data-speed="0.8"></div>
		<div class="container">
			<div class="row">
				<div class="col">
					<div class="intro_container d-flex flex-column align-items-start justify-content-end">
						<div class="intro_content">
							...
							<div class="rating_r rating_r_4 intro_rating"><i></i><i></i><i></i><i></i></div>
							<div class="intro_title">Vocabulary. Part 1</div>
							<div class="intro_meta">
								<div class="intro_image"><img src="/img/intro_user.jpg" alt=""></div>
