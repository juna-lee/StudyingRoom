		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4">
					<div class="effect-wrap">
    					<figure class="effect6">
       						 <img src="https://tistory4.daumcdn.net/tistory/2141493/skin/images/simg07.png" alt="">
       						 <figcaption>
			...
			<div class="col-lg-4 offset-lg-1">
				<div class="lookbok-left">
					...
					<p>Fusce urna quam, euismod sit amet mollis quis, vestibulum
						...
						eleifend, sodales nulla vitae, scelerisque ante. Nunc id vulputate
						dui. Suspendisse consectetur rutrum metus nec scelerisque. s</p>
